...
(self.webpackChunkrestasaurus_docs = self.webpackChunkrestasaurus_docs || []).push([
    [253],
    {
        5668: (e, n, t) => {
            ...
            var s = t(5893),
                i = t(1151);
            const r = { title: 'Clades' },
                a = void 0,
                o = {
                    id: 'endpoints/clades',
                    title: 'Clades',
                    description: 'API Endpoint and Description',
                    source: '@site/docs/endpoints/clades.md',
                    sourceDirName: 'endpoints',
                    slug: '/endpoints/clades',
                    permalink: '/restasaurus/endpoints/clades',
                    draft: !1,
                    unlisted: !1,
                    tags: [],
                    version: 'current',
                    frontMatter: { title: 'Clades' },
                    sidebar: 'docs',
                    previous: { title: 'Home', permalink: '/restasaurus/endpoints/home' },
                    next: { title: 'Diets', permalink: '/restasaurus/endpoints/diets' },
                },
                d = {},
                c = [
            ...
            function l(e) {
                ...
                return (0, s.jsxs)(s.Fragment, {
                    children: [
                        ...
                        '\n',
                        (0, s.jsx)(n.p, { children: (0, s.jsx)(n.code, { children: 'GET {baseUrl}/api/v1/clades' }) }),
                        '\n',
                        (0, s.jsx)(n.p, { children: 'Returns all dinosaur clades that exist within the API.' }),
                        '\n',
        ...
        2916: (e, n, t) => {
            t.d(n, { Z: () => s });
            const s = t.p + 'assets/images/clades-ec7a4dfa9aefc4c3588632ed20b0efb5.gif';
        },
        1151: (e, n, t) => {
            t.d(n, { Z: () => o, a: () => a });
            var s = t(7294);
