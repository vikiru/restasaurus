 ...
 */
async function returnHome(_req, res) {
  res.status(200).json({
    apiVersion: 'v1',
    apiEndpoints,
...
async function retrieveAllDinosaurs(req, res) {
  try {
    ...
    if (result.data.length > 0) {
      ...
      res
        .status(404)
        .json({ error: 'Sorry, there was an error retrieving all dinosaurs' });
    }
  } catch (error) {
    logger.error(error);
    res.status(500).json({
 ...
 * @param {object} res - The response object.
 */
async function retrieveAllNames(_req, res) {
  try {
 ...
 * @param {object} res - The response object.
 */
async function retrieveAllDiets(_req, res) {
  try {
    ...
    res.status(500).json({
      error:
        'Sorry, an unexpected error occurred while retrieving all dinosaur diets',
    });
  }
}
 ...
 * @param {object} res - The response object.
 */
async function retrieveAllLocomotions(_req, res) {
  try {
 ...
 * @param {object} res - The response object.
 */
async function retrieveAllClades(_req, res) {
  try {
...
async function retrieveDinoById(req, res) {
  try {
    ...
    res.status(500).json({
      error:
        'Sorry, an unexpected error occured while retrieving a dinosaur matching the specified id.',
    });
  }
}
...
async function retrieveDinoByName(req, res) {
  try {
    ...
    res.status(500).json({
      error:
        'Sorry, an unexpected error occured trying to find a dinosaur matching that name.',
    });
  }
}
...
async function retrieveDinoByDiet(req, res) {
  try {
    ...
    if (dinosaurs.length > 0) {
      ...
      res.status(404).json({
        error:
          "Sorry, there doesn't seem to be any dinosaurs matching that diet.",
      });
    }
  } catch (error) {
    logger.error(error);
    res.status(500).json({
      error:
        'Sorry, an unexpected error occured while retrieving all dinosaurs matching that diet.',
    });
  }
}
...
async function retrieveDinoByLocomotion(req, res) {
  try {
    ...
    if (dinosaurs.length > 0) {
      ...
      res.status(404).json({
        error:
          "Sorry, there doesn't seem to be any dinosaurs matching that locomotion type.",
      });
    }
  } catch (error) {
    logger.error(error);
...
async function retrieveImageById(req, res) {
  try {
    ...
    if (dinosaurImage) {
      ...
      res.status(404).json({
        error:
          'Sorry, there doesnt seem to be a dinosaur image matching that id.',
      });
    }
  } catch (error) {
    logger.error(error);
    res.status(500).json({
      error:
        'Sorry, an unexpected occurred while trying to recieve an image matching that id.',
    });
  }
}
...
async function retrieveRandomDinosaurs(req, res) {
  ...
  try {
    ...
    res.status(500).json({
      error:
        'Sorry, an unexpected error occurred while trying to retrieve a random number of dinosaurs.',
    });
  }
}
...
async function retrieveRandomImages(req, res) {
  ...
  try {
    ...
    res.status(500).json({
      error:
        'Sorry, an unexpected error occurred while trying to retrieve a random number of dinosaur images.',
    });
  }
}
...
async function retrieveDinosaursByQuery(req, res) {
  try {
    ...
    if (dinosaurs.length > 0) {
      ...
      res.status(404).json({
        error:
          'Sorry, there doesnt seem to be any dinosaurs matching that query.',
      });
    }
  } catch (err) {
